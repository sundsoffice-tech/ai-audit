...
def test_no_hacca_imports():
    ...
    Modules that depend on optional packages (fastapi, asyncpg, hvac, mcp, …)
    intentionally raise ImportError at import time when those are missing.
    Skip any module that fails to import — if it can't import at all, it
    can't leak HACCA imports either, which is what this test guards.
    """
    import importlib
    import pkgutil
